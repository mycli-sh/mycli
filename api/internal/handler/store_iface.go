...
// CommandStore is the subset of store.Store used by CommandHandler.
...
// CatalogStore is the subset of store.Store used by CatalogHandler.
type CatalogStore interface {
	...
	ListCommandsByLibrary(ctx context.Context, libraryID string) ([]store.LibraryCommand, error)
}

// MeStore is the subset of store.Store used by MeHandler.
...
// SessionStore is the subset of store.Store used by SessionHandler.
...
// LibraryStore is the subset of store.Store used by LibraryHandler.
...
// WebAuthStore is the subset of store.Store used by WebAuthHandler.
