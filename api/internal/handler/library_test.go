...
type mockLibraryStore struct {
	...
	CreateLibraryReleaseFn             func(ctx context.Context, libraryID uuid.UUID, version, tag, commitHash string, contentSHA256 *string, commandCount int, releasedBy uuid.UUID) (*model.LibraryRelease, error)
...
func (m *mockLibraryStore) CreateLibraryRelease(ctx context.Context, libraryID uuid.UUID, version, tag, commitHash string, contentSHA256 *string, commandCount int, releasedBy uuid.UUID) (*model.LibraryRelease, error) {
	return m.CreateLibraryReleaseFn(ctx, libraryID, version, tag, commitHash, contentSHA256, commandCount, releasedBy)
}
